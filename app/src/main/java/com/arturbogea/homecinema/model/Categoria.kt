...
data class Filme(@SerializedName("url_imagem") val capa: String? = null, @SerializedName("id") val id: Int = 0, val nome: String? = null, val descricao: String? = null, val elenco: String? = null)
